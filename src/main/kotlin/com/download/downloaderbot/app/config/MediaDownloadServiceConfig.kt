...
class MediaDownloadServiceConfig {
    @Bean
    fun mediaDownloadService(downloaders: Map<String, MediaProvider>): MediaService = DefaultMediaService(downloaders)
    ...
    ): MediaService = PipelineMediaService(core, interceptors)
}
