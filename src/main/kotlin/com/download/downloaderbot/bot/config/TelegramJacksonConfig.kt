...
class TelegramJacksonConfig {
    @Bean
    fun telegramEnumsModule(): Module = SimpleModule("TelegramEnums").apply {
        addDeserializer(MessageEntity.Type::class.java,
            object : JsonDeserializer<MessageEntity.Type>() {
                override fun deserialize(p: JsonParser, ctxt: DeserializationContext): MessageEntity.Type {
