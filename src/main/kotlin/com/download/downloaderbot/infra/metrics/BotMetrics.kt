...
class BotMetrics(
    ...
    fun commandTimer(command: String): Timer =
        Timer
            .builder("downloader_update_duration_seconds")
    ...
    fun jobQueueDelayTimer(job: String): Timer =
        Timer
            .builder("downloader_job_queue_delay_seconds")
    ...
    fun jobDurationTimer(job: String): Timer =
        Timer
            .builder("downloader_job_duration_seconds")
    ...
    fun jobTotalDurationTimer(job: String): Timer =
        Timer
            .builder("downloader_job_total_duration_seconds")
